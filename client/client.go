...
func logResponse(res *pb.EmailReponse, err error) {
	if err != nil {
...
func getEmailBatch(client pb.MailingListServiceClient, page int, count int) {
...
func main() {
	...
	newEmail := createEmail(client, "999@999.9999")
